...
class Calculations {
  ...
  fromGregorian(settings, gregorianDate) {
    ...
    const malayalaMasaNum = (sakaDate.sauraMasa - 4 + 12 ) % 12;
    ...
    kollavarshamDate.sauraMasa = sakaDate.sauraMasa;
    kollavarshamDate.sauraDivasa = sakaDate.sauraDivasa;
    kollavarshamDate.naksatra = sakaDate.naksatra;
  ...
  toGregorianFromSaka(sakaDate) {
    ...
    const ahargana = this.calendar.kaliToAhargana(kaliYear, masaNum, calendarData.tithiDay);
    this.getPaksa();
