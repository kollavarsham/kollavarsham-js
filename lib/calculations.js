...
class Calculations {
  ...
  fromGregorianToSaka(settings, gregorianDate) {
    ...
    // kali and Saka era
    const kaliYear = this.calendar.aharganaToKali(ahargana + ( 4 - calendarData.masaNum ) * 30);
  ...
  toGregorianFromSaka(sakaDate) {
    ...
    const ahargana = this.calendar.kaliToAhargana(kaliYear, calendarData.masaNum, calendarData.tithiDay);
    this.getPaksa();
