...
class Calculations {
  ...
  fromGregorianToSaka(settings, gregorianDate) {
    ...
    const tithiDay = calendarData.tithiDay = MathHelper.truncate(tithi) + 1;
    calendarData.ftithi = MathHelper.fractional(tithi);

    // TODO: Change the method name below
    const paksa = this.setPaksa();
    ...
    sakaDate.sauraMasa = sauraMasaMonthDay.month;
    sakaDate.sauraDivasa = sauraMasaMonthDay.day;
