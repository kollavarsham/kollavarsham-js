...
class Celestial {
  ...
  getLastConjunctionLongitude(ahargana, tithi) {
    ...
    console.log(`ahargana: ${ ahargana } `);
    console.log(`this.backLastConjunctionAhargana: ${ this.backLastConjunctionAhargana } `);
    console.log(`this.backNextConjunctionAhargana: ${ this.backNextConjunctionAhargana } `);

    console.log(`Math.abs(ahargana - this.backLastConjunctionAhargana): ${ Math.abs(ahargana - this.backLastConjunctionAhargana) } `);
    console.log(`Math.abs(ahargana - this.backNextConjunctionAhargana): ${ Math.abs(ahargana - this.backNextConjunctionAhargana) } `);
