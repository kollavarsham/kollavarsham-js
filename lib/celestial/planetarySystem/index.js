...
class PlanetarySystem {
  ...
  constructor(system = 'SuryaSiddhanta') {
    ...
    planetsList = _.indexBy([star, sun, moon, mercury, venus, mars, jupiter, saturn, candrocca, rahu], 'name');
  ...
  initializeYugaRotations() {
    ...
    // # Saura, HIL, p.15 && # Latadeva/Ardharatrika, HIL, p.15star.YugaRotation = isSuryaSiddhantaSystem ? 1582237800 : 1582237828;
