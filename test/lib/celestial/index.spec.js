...
describe('Celestial', function () {
  ...
  describe('getTrueLongitude', function () {
    ...
    it('should return correct results', function () {
      ...
      expect(celestial.getTrueLongitude(1710693, 215.330481398828, 'mercury')).to.be.closeTo(290.256193246842, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1710694, 216.345092245966, 'mercury')).to.be.closeTo(287.939466847665, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1710695, 217.360117559963, 'mercury')).to.be.closeTo(285.69872602331, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1710696, 218.375548627069, 'mercury')).to.be.closeTo(283.567766431273, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1772755, 183.139229101953, 'mercury')).to.be.closeTo(292.367822361191, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1772756, 184.136821438217, 'mercury')).to.be.closeTo(293.462095381124, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1772757, 185.135030298228, 'mercury')).to.be.closeTo(294.554161309681, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1132992, 355.302664567532, 'mercury')).to.be.closeTo(294.330597635538, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1868191, 288.309252298232, 'mercury')).to.be.closeTo(280.5291286866, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1868192, 289.32751969395, 'mercury')).to.be.closeTo(281.497932838323, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1867492, 320.200309773426, 'mercury')).to.be.closeTo(285.388042602287, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1867886, 348.803993428264, 'mercury')).to.be.closeTo(308.404674687418, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1867520, 348.072902270539, 'mercury')).to.be.closeTo(312.012169567129, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1844848, 322.249740952942, 'mercury')).to.be.closeTo(287.862667589296, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1710693, 215.330481398828, 'venus')).to.be.closeTo(324.308933009715, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1710694, 216.345092245966, 'venus')).to.be.closeTo(321.407541005215, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1710695, 217.360117559963, 'venus')).to.be.closeTo(318.226901026202, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1710696, 218.375548627069, 'venus')).to.be.closeTo(314.775291122611, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1772755, 183.139229101953, 'venus')).to.be.closeTo(253.240856229459, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1772756, 184.136821438217, 'venus')).to.be.closeTo(253.582115854346, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1772757, 185.135030298228, 'venus')).to.be.closeTo(253.942554219963, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1132992, 355.302664567532, 'venus')).to.be.closeTo(331.723144303665, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1868191, 288.309252298232, 'venus')).to.be.closeTo(344.369387070859, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1868192, 289.32751969395, 'venus')).to.be.closeTo(344.125688357144, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1867492, 320.200309773426, 'venus')).to.be.closeTo(338.204333524322, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1867886, 348.803993428264, 'venus')).to.be.closeTo(303.63668762932, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1867520, 348.072902270539, 'venus')).to.be.closeTo(343.326701630526, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1844848, 322.249740952942, 'venus')).to.be.closeTo(289.230030387495, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1710693, 215.330481398828, 'mars')).to.be.closeTo(158.887067202077, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1710694, 216.345092245966, 'mars')).to.be.closeTo(159.240835569617, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1710695, 217.360117559963, 'mars')).to.be.closeTo(159.593872869183, MathHelper.epsilon);
      expect(celestial.getTrueLongitude(1710696, 218.375548627069, 'mars')).to.be.closeTo(159.946154425643, MathHelper.epsilon);
